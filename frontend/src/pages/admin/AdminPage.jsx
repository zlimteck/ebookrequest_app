                              ...
                              <div className={styles.statusButtons}>
                                ...
                                {(request.status === 'completed' || request.status === 'canceled') && (<>
                                  ...
                                  {request.status === 'completed' && request.filePath && (
                                    <button className={styles.aIconBtn} title="Étagères Calibre-Web"
                                      onClick={() => setExtraShelvesModal(request)}>
                                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18"/><path d="M3 8h18"/><path d="M3 13h18"/><path d="M3 18h18"/></svg>
                                    </button>
                                  )}
